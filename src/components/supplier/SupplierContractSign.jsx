    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Quotation Contract Details</CardTitle>
            </CardHeader>
            <CardContent>
              <div
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Sign Quotation</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {signatory.signing_status === 'signed' ? (
                ...
                <>
                  ...
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <label className="flex items-start gap-2 cursor-pointer">
                      ...
                      <span className="text-xs text-blue-900">
                        I confirm that I am authorized to sign this quotation contract on behalf of the company
                      </span>
                    </label>
                  </div>
                  ...
                  >
                    {signing ? 'Signing...' : 'Sign Quotation Contract'}
                  </Button>
                </>
              )}
            </CardContent>
